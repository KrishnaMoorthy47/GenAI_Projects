...
llm_openai = AzureChatOpenAI(model_name = "gpt-4o", azure_endpoint = "YOUR_AZURE_ENDPOINT", api_version="2024-10-21", api_key = OpenAI_API_KEY)
...
crew.kickoff(inputs={"query": "What is the current price of Apple?", "default_date": "2025-10-01"})
...
st.markdown("---")
st.markdown("Made by Krishna Moorthy")